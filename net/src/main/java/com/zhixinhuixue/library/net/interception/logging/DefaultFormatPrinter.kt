package com.zhixinhuixue.library.net.interception.logging

import android.text.TextUtils
import com.zhixinhuixue.library.net.interception.LogInterceptor.Companion.isJson
import com.zhixinhuixue.library.net.interception.LogInterceptor.Companion.isXml
import com.zhixinhuixue.library.net.interception.logging.util.CharacterHandler.Companion.jsonFormat
import com.zhixinhuixue.library.net.interception.logging.util.CharacterHandler.Companion.xmlFormat
import com.zhixinhuixue.library.net.interception.logging.util.LogUtils
